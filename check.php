...
{
header("location:loginform.php?msg=Wrong password");
}
else if($dbuname! =$uname && $dbpword==$pword)
{
header("location:loginform.php?msg=Wrong username");
}
}
else {
header("location:loginform.php?msg=Wrong username and password");
}
}
?>
